...
int deletefromhead(request *&U, request *del){
        U = U -> next;
        //cout << U << endl;
}
...
*/
    ...
    for(int j = 0; j < i; j++){
        ...
        //cout << time << " ";
        if(mark == initialREQ){
            //cout << "delete head, address: "<< mark << endl;
            deletefromhead(initialREQ, mark);
 
        }
        else if(mark != initialREQ){
            //cout << "delete not head, address: " << mark << endl;
            deletefrom(initialREQ, mark);
            // cout << "deleted not head, address: " << mark << endl;
        }
        REQ = initialREQ;
        //cout << initialREQ << " ";
    }
